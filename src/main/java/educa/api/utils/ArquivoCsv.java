...
public class ArquivoCsv {
    ...
    public static void gravaArquivoCsv(ListObj<Conteudo> lista,
        ...
        try {
            for (int i = 0; i < lista.getTamanho(); i++) {
                ...
                saida.format("%s;%s;%s;%s;%d\n",c.getTitulo(),c.getUrlVideo(),
                        c.getTexto(), c.getDataCriacao(), c.getTempoEstimado());
            }
        }
    ...
    public static void leExibeArquivoCsv(String nomeArq) {
        ...
        try {
            System.out.printf("%-6S %-3S %5S %11s %13s\n", "Título", "Url",
                    "Texto", "DataCriação", "TempoEstimado");
            while (entrada.hasNext()) {
                ...
                System.out.printf("%-6S %-3S %5S %11s %13s\n", titulo, url,
                        texto, dataCriacao, tempoEstimado);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        lista.adiciona(new Conteudo(1, "Matemática", "aulasdematematica.com/aulas/conteudo",
                "1. Aulas de matemática aplicada", LocalDateTime.now() , 10));
        lista.adiciona(new Conteudo(2, "Matemática", "aulasdematematica.com/aulas/conteudo",
